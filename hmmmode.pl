	...
	foreach $clus_no (sort keys %hash_info)			 					
	{
		...
		if (scalar @own_seq >=3)			 
		{
			...
			if (scalar @fp_ids > 200)		
			{
				...
				system "/home/swati/bin/bin/mcxassemble -b $file.blast -q -r max --map";
				system "/home/swati/bin/bin/mcl $file.blast.sym -scheme 7 -I 1.2 -o $file.clus --append-log=yes";
